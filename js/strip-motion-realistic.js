document.addEventListener('DOMContentLoaded', () => {
  ...
  let today_start = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 8); // для теста 0, в реальности - 8
  let today_end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 23); // для теста 0, в реальности - 23
  ...
  if (today_start <= requestedDay && requestedDay >= requestedDay) {
    ...
    let msRemainedToTheNextStep = (1 - (minutesPassed - minutesPassedRounded))*1000*60; // Еще умножить на 60
